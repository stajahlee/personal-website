...
describe("ContactPage", () => {
  ...
  it("renders linkedin card and link", () => {
    ...
    expect(within(linkedInCard).getByRole("img").firstChild).toHaveClass(
      "lucide-linkedin",
    );
  });
  ...
  it("renders github card and link", () => {
    ...
    expect(within(githubCard).getByRole("img").firstChild).toHaveClass(
      "lucide-github",
    );
  });
  ...
  it("renders email card and link", () => {
    ...
    expect(within(emailCard).getByRole("img").firstChild).toHaveClass(
      "lucide-mail",
    );
  });
});
