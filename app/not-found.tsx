  ...
  return (
    <>
      <div className="bg-image-wrapper md:bg-image-wrapper-md">
        <Image src="/images/galaxy.jpg" alt="Outerspace" quality="100" fill />
      </div>
      ...
      <div className="relative z-10 flex flex-col gap-5 justify-center items-center mb-10 md:mb-0 sm:pb-2 pt-global-header md:pb-8 z-10 h-screen mx-auto overflow-hidden bg-cover">
        ...
        <Link
          href="/"
          className="animate-fade-in mt-4 rounded-md bg-violet-600 px-3.5 py-2 text-sm font-semibold text-white shadow-sm hover:bg-violet-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
        >
          go home
        </Link>
      </div>
